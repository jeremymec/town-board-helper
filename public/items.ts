const items = [
  ...
  { id: "saltt1", name: "Salt", categories: [] },
  { id: "faction_provisions01_t1", name: "Dried Meat Samples", categories: [] },
  { id: "sugart1", name: "Sugar", categories: [] },
  { id: "faction_provisions01_t2", name: "Meat Jerky Rations", categories: [] },
  { id: "gingert1", name: "Ginger", categories: [] },
  {
  ...
  { id: "thymet1", name: "Thyme", categories: ["Seasonings", "herbs"] },
  { id: "saget1", name: "Sage", categories: ["Seasonings", "herbs"] },
  { id: "mintt1", name: "Mint", categories: ["Seasonings", "herbs"] },
  { id: "tarragont1", name: "Tarragon", categories: ["Seasonings", "herbs"] },
  {
  ...
  { id: "fishoilt1", name: "Fish Oil", categories: [] },
  {
    id: "faction_provisions02_t1",
    name: "Canned Fish Samples",
    categories: [],
  },
  { id: "dillt1", name: "Dill", categories: ["Seasonings", "herbs"] },
  {
  ...
  { id: "faction_provisions02_t4", name: "Vegetable Supplies", categories: [] },
  { id: "nutmegt1", name: "Nutmeg", categories: [] },
  { id: "paprikat1", name: "Paprika", categories: [] },
  { id: "cinnamont1", name: "Cinnamon", categories: [] },
  { id: "faction_provisions02_t5", name: "Spice Stockpile", categories: [] },
  {
    id: "cranberryt1",
    name: "Cranberry",
    categories: [
  ...
  { id: "watert1", name: "Water", categories: [] },
  { id: "faction_provisions03_t1", name: "Juice Samples", categories: [] },
  {
  ...
  { id: "milkt1", name: "Milk", categories: ["Raw Foods", "Tier 1 Raw Foods"] },
  { id: "faction_provisions03_t3", name: "Yoghurt Provisions", categories: [] },
  {
    id: "barleyt1",
    name: "Barley",
    categories: [
  ...
  { id: "nutt1", name: "Nut", categories: ["Raw Foods", "Tier 1 Raw Foods"] },
  { id: "honeyt1", name: "Honey", categories: ["Seasonings", "Raw Foods"] },
  { id: "faction_provisions03_t4", name: "Cereal Supplies", categories: [] },
  {
    id: "poultryt1",
    name: "Poultry",
    categories: ["Tier 1 Meats", "Raw Meats", "Raw Foods", "Tier 1 Raw Foods"],
  ...
  { id: "faction_provisions03_t5", name: "Meat Stockpile", categories: [] },
  { id: "cookingoilt1", name: "Cooking Oil", categories: [] },
  {
  ...
  { id: "yeastt1", name: "Yeast", categories: [] },
  { id: "cheeset1", name: "Cheese", categories: [] },
  { id: "buttert1", name: "Butter", categories: [] },
  { id: "faction_provisions04_t4", name: "Dairy Supplies", categories: [] },
  { id: "garlict1", name: "Garlic", categories: [] },
  {
  ...
  { id: "rosemaryt1", name: "Rosemary", categories: ["Seasonings", "herbs"] },
  {
    id: "faction_provisions05_t2",
    name: "Herbal Game Rations",
    categories: [],
  },
  { id: "basilt1", name: "Basil", categories: ["Seasonings", "herbs"] },
  { id: "oreganot1", name: "Oregano", categories: ["Seasonings", "herbs"] },
  { id: "parsleyt1", name: "Parsley", categories: ["Seasonings", "herbs"] },
  {
  ...
  { id: "flourt1", name: "Flour", categories: [] },
  { id: "eggt1", name: "Egg", categories: ["Raw Foods", "Tier 1 Raw Foods"] },
  {
    id: "pastat1",
    name: "Pasta",
  ...
  { id: "faction_provisions05_t4", name: "Carb Supplies", categories: [] },
  {
    id: "wheatt1",
    name: "Wheat",
    categories: ["Tier 4 Grains", "Raw Foods", "Tier 4 Raw Foods"],
  },
  { id: "faction_provisions05_t5", name: "Cereal Stockpile", categories: [] },
  {
    id: "faction_provisions06_t2",
    name: "Garlic Meat Rations",
    categories: [],
  },
  { id: "faction_provisions06_t3", name: "Spice Provisions", categories: [] },
  {
    id: "blueberryt1",
    name: "Blueberry",
    categories: [
  ...
  { id: "faction_provisions06_t4", name: "Fruit Supplies", categories: [] },
  {
    id: "oranget1",
    name: "Orange",
    categories: [
  ...
  { id: "faction_provisions06_t5", name: "Fruit Stockpile", categories: [] },
  { id: "faction_provisions07_t2", name: "Breakfast Rations", categories: [] },
  { id: "peppercornt1", name: "Peppercorn", categories: [] },
  {
  ...
  { id: "faction_provisions07_t4", name: "Luxury Supplies", categories: [] },
  { id: "faction_provisions07_t5", name: "Baking Stockpile", categories: [] },
  { id: "faction_provisions08_t2", name: "Herb Rations", categories: [] },
  { id: "faction_provisions08_t3", name: "Meat Provisions", categories: [] },
  {
    id: "faction_provisions08_t4",
    name: "Exotic Herb Supplies",
    categories: [],
  },
  { id: "seasoningblendt1", name: "Seasoning Blend", categories: [] },
  {
    id: "faction_provisions08_t5",
    name: "Condiment Stockpile",
    categories: [],
  },
  { id: "faction_provisions09_t2", name: "Carb Rations", categories: [] },
  {
  ...
  { id: "faction_provisions09_t5", name: "Carb Stockpile", categories: [] },
  {
    id: "lemont1",
    name: "Lemon",
    categories: [
  ...
  { id: "faction_provisions10_t3", name: "Baking Provisions", categories: [] },
  { id: "faction_provisions10_t4", name: "Condiment Supplies", categories: [] },
  {
    id: "meatsquidt1",
    name: "Squid Meat",
    categories: ["Tier 3 Meats", "Raw Meats", "Raw Foods", "Tier 3 Raw Foods"],
  ...
  { id: "foodhealthrecoveryt1", name: "Light Ration", categories: [] },
  { id: "foodhealthrecoveryt2", name: "Travel Ration", categories: [] },
  { id: "foodhealthrecoveryt3", name: "Light Meal", categories: [] },
  { id: "foodhealthrecoveryt4", name: "Satisfying Meal", categories: [] },
  { id: "foodhealthrecoveryt5", name: "Hearty Meal", categories: [] },
  { id: "foodmanat1", name: "Energizing Light Ration", categories: [] },
  { id: "foodmanat2", name: "Energizing Travel Ration", categories: [] },
  { id: "foodmanat3", name: "Energizing Light Meal", categories: [] },
  { id: "foodmanat4", name: "Energizing Satisfying Meal", categories: [] },
  { id: "foodmanat5", name: "Energizing Hearty Meal", categories: [] },
  {
    id: "workorder_faction_armaments01_t2",
    name: "Weaponsmithing Work Order",
    categories: [],
  },
  { id: "oret1", name: "Iron Ore", categories: [] },
  { id: "woodt1", name: "Green Wood", categories: [] },
  { id: "rawhidet1", name: "Rawhide", categories: [] },
  {
  ...
  { id: "rawhidet0", name: "Rawhide Scraps", categories: [] },
  {
    id: "leathert2",
    name: "Coarse Leather",
  ...
  { id: "charcoalt1", name: "Charcoal", categories: [] },
  {
    id: "ingott3",
    name: "Steel Ingot",
    categories: ["Tier 3 Metals", "Metals"],
  },
  { id: "woodt2", name: "Aged Wood", categories: [] },
  {
    id: "timbert3",
    name: "Lumber",
  ...
  { id: "fibert1", name: "Fibers", categories: [] },
  {
    id: "faction_armorset01_t2",
    name: "Set of Rugged Crude Iron Armor",
    categories: [],
  },
  { id: "clotht2", name: "Linen", categories: ["Tier 2 Cloth", "Cloth"] },
  {
    id: "faction_armorset01_t3",
    name: "Set of Rugged Iron Armor",
    categories: [],
  },
  { id: "clotht3", name: "Sateen", categories: ["Tier 3 Cloth", "Cloth"] },
  {
    id: "faction_armorset01_t4",
    name: "Set of Rugged Steel Armor",
    categories: [],
  },
  { id: "fibert4", name: "Silk Threads", categories: [] },
  { id: "clotht4", name: "Silk", categories: ["Tier 4 Cloth", "Cloth"] },
  {
  ...
  { id: "herbt1", name: "Hyssop", categories: [] },
  { id: "alkahestt1", name: "Weak Alkahest", categories: [] },
  { id: "potionmanat1", name: "Weak Mana Potion", categories: [] },
  { id: "alkahestt2", name: "Common Alkahest", categories: [] },
  { id: "potionmanat2", name: "Common Mana Potion", categories: [] },
  { id: "alkahestt3", name: "Strong Alkahest", categories: [] },
  { id: "potionmanat3", name: "Strong Mana Potion", categories: [] },
  { id: "alkahestt4", name: "Powerful Alkahest", categories: [] },
  { id: "potionmanat4", name: "Powerful Mana Potion", categories: [] },
  { id: "azothwatert1", name: "Azoth Water", categories: [] },
  { id: "alkahestt5", name: "Infused Alkahest", categories: [] },
  { id: "potionmanat5", name: "Infused Mana Potion", categories: [] },
  { id: "potionhealtht1", name: "Weak Health Potion", categories: [] },
  { id: "potionhealtht2", name: "Common Health Potion", categories: [] },
  { id: "potionhealtht3", name: "Strong Health Potion", categories: [] },
  { id: "potionhealtht4", name: "Powerful Health Potion", categories: [] },
  { id: "potionhealtht5", name: "Infused Health Potion", categories: [] },
  { id: "potionregent1", name: "Common Regeneration Potion", categories: [] },
  { id: "potionregent2", name: "Strong Regeneration Potion", categories: [] },
  { id: "potionregent3", name: "Powerful Regeneration Potion", categories: [] },
  { id: "potionregent4", name: "Infused Regeneration Potion", categories: [] },
  {
